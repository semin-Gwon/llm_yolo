...
- 참고 저장소: `https://github.com/leesj24601/Go2_Intelligence_Framework.git
...
# 5. 대체 대상 탐색
ros2 topic pub --once /user_text std_msgs/msg/String "{data: 의자 찾고 없으면 TV 찾아'}"
# 기대: 첫 대상 실패 후 다음 대상 탐색으로 전환 (즉시 abort 아님)
